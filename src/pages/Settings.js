...
import { UpdateBackupDatabase } from '../components/_dashboard/settings';
import { SettingsCategoryEnum, MallAccrEnum, smSalesTypeEnum } from '../enum/Settings';
...
export const paymentMethodsStatic = [
      ...
      <Container>
        ...
        <Grid container spacing={3} pb={4}>
          ...
          {user.username === 'umbra_admin' && (
            <>
              <Grid item xs={12}>
                <Typography variant="h4">BIR Information</Typography>
              </Grid>
              <Grid item xs={4}>
                <TextField
                  fullWidth
                  label="VAT REG"
                  type="text"
                  value={settingsData[SettingsCategoryEnum.BirInfo].vatReg}
                  onChange={(e) =>
                    handleUpdateSettings(SettingsCategoryEnum.BirInfo, {
                      vatReg: e.target.value
                    })
                  }
                />
              </Grid>
              <Grid item xs={4}>
                <TextField
                  ...
                  label="ACCR"
                  type="text"
                  value={settingsData[SettingsCategoryEnum.BirInfo].accr}
                  onChange={(e) =>
                    handleUpdateSettings(SettingsCategoryEnum.BirInfo, {
                      accr: e.target.value
                    })
              ...
              <Grid item xs={4}>
                <TextField
                  ...
                  label="Version"
                  type="text"
                  value={settingsData[SettingsCategoryEnum.BirInfo].birVersion}
                  onChange={(e) =>
                    handleUpdateSettings(SettingsCategoryEnum.BirInfo, {
                      birVersion: e.target.value
                    })
                  }
                />
              </Grid>
              <Grid item xs={4}>
                <TextField
                  fullWidth
                  label="Accr. Date Issued"
                  type="text"
                  value={settingsData[SettingsCategoryEnum.BirInfo].accrDateIssued}
                  onChange={(e) =>
                    handleUpdateSettings(SettingsCategoryEnum.BirInfo, {
                      accrDateIssued: e.target.value
                    })
                  }
                />
              </Grid>
              <Grid item xs={4}>
                <TextField
                  fullWidth
                  label="Tax Code Regular"
                  type="text"
                  value={settingsData[SettingsCategoryEnum.BirInfo].taxCodeRegular}
                  onChange={(e) =>
                    handleUpdateSettings(SettingsCategoryEnum.BirInfo, {
                      taxCodeRegular: e.target.value
                    })
                  }
                />
              </Grid>
              <Grid item xs={4}>
                <TextField
                  fullWidth
                  label="Tax Code Zero Rated"
                  type="text"
                  value={settingsData[SettingsCategoryEnum.BirInfo].taxCodeZeroRated}
                  onChange={(e) =>
                    handleUpdateSettings(SettingsCategoryEnum.BirInfo, {
                      taxCodeZeroRated: e.target.value
                    })
                  }
                />
              </Grid>
              <Grid item xs={4}>
                <TextField
                  ...
                  type="text"
                  value={settingsData[SettingsCategoryEnum.BirInfo].taxCodeExempt}
                  onChange={(e) =>
                    handleUpdateSettings(SettingsCategoryEnum.BirInfo, {
                      taxCodeExempt: e.target.value
                    })
                  }
                />
              </Grid>
